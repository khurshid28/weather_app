...
class DailyCard extends StatelessWidget {
  ListElement element;
   DailyCard({super.key,required this.element});
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
              DateFormat.yMMMEd().format(element.dtTxt).split(",")[1],
            style: TextStyle(
              color: Colors.white,
              fontSize: 16.sp,
          ...
          Image.network('http://openweathermap.org/img/w/${element.weather[0].icon}.png',),
          SizedBox(
            height: 4.w,
          ),
          Text(
